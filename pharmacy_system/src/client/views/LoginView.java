...
public class LoginView extends JPanel {
    ...
    private JTextField txtUsername, txtRegUsername, txtFullName, txtEmail, txtAddress, txtContactNumber;
    ...
    private JPanel createLoginPanel() {
        ...
        // Title
        JLabel lblTitle = new JLabel("RxPRESS");
        ...
        JLabel lblSubtitle = new JLabel("Reserve in a Click! Pick up Quick!");
        ...
        txtUsername.setForeground(new Color(128, 128, 128, 150)); // Reduced opacity gray
        ...
        txtUsername.addFocusListener(new java.awt.event.FocusAdapter() {
            ...
            public void focusLost(java.awt.event.FocusEvent e) {
                if (txtUsername.getText().trim().isEmpty()) {
                    txtUsername.setText("Username");
                    txtUsername.setForeground(new Color(128, 128, 128, 150));
                }
            }
        });
        ...
        txtPassword.setEchoChar((char)0); // Show password as plain text initially
        txtPassword.setText("Password");
        txtPassword.setForeground(new Color(128, 128, 128, 150)); // Reduced opacity gray
        // Add focus listener for placeholder behavior
        txtPassword.addFocusListener(new java.awt.event.FocusAdapter() {
            ...
            public void focusGained(java.awt.event.FocusEvent e) {
                if (new String(txtPassword.getPassword()).equals("Password")) {
                    txtPassword.setText("");
                    txtPassword.setEchoChar('*'); // Show password dots when typing
            ...
            public void focusLost(java.awt.event.FocusEvent e) {
                if (txtPassword.getPassword().length == 0) {
                    txtPassword.setEchoChar((char)0); // Show plain text for placeholder
                    txtPassword.setText("Password");
                    txtPassword.setForeground(new Color(128, 128, 128, 150));
                }
            }
        });
    ...
    private JPanel createRegisterPanel() {
        ...
        form.add(createLabel("Contact Number"), gbc);
        gbc.gridx = 1; gbc.weightx = 1;
        txtContactNumber = createTextField();
        form.add(txtContactNumber, gbc);
        ...
        form.add(createLabel("Account Type"), gbc);
        gbc.gridx = 1; gbc.weightx = 1;
        cmbAccountType = new JComboBox<>(new String[]{"RESIDENT", "PHARMACY"});
        cmbAccountType.setFont(new Font("SansSerif", Font.PLAIN, 13));
    ...
    private void handleRegister() {
        ...
        if (fullName.isEmpty() || email.isEmpty() || contactNumber.isEmpty() || address.isEmpty() || username.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(mainFrame, "Please fill all fields!",
                "Validation", JOptionPane.WARNING_MESSAGE);
            return;
        }
        mainFrame.handleRegister(username, password, fullName, email, contactNumber, address, accountType);
        cardLayout.show(this, "LOGIN");
        txtFullName.setText(""); txtEmail.setText(""); txtContactNumber.setText(""); txtAddress.setText("");
